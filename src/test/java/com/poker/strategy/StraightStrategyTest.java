...
public class StraightStrategyTest {
    ...
    void testStraight() {
        ...
        StraightStrategy strategy = new StraightStrategy();
        assertTrue(strategy.isValid(straight));
    }

    @Test
    void testNotStraight() {
        List<Card> notStraight = Arrays.asList(
                new Card(CardValue.TWO, Suits.HEART.getSuit()),
                new Card(CardValue.THREE, Suits.DIAMOND.getSuit()),
        ...
        StraightStrategy strategy = new StraightStrategy();
        assertFalse(strategy.isValid(notStraight));
    }
}